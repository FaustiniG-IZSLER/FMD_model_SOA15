...
# Infectivity parameters of the farms type
    mydata['sus'] = numpy.random.beta(90,10, 3074)
    mydata['bos'] = numpy.random.beta(45,55, 3074)
    mydata['susmall'] = numpy.random.beta(45,55, 3074)
    mydata['bosmall'] = numpy.random.beta(25,75, 3074)
...
# Susceptibility parameters of the farms type 
    mydata['expbos'] = numpy.random.beta(90,10, 3074)
    mydata['expsus'] = numpy.random.beta(6, 94, 3074)
...
# Alternative hard removal criterium: degree 
    ...
    top1500 = top_nodes[0:1499] # first 1500 herds in terms of degree as an index of connectedness 
...
df1700 = pd. DataFrame(outputtrends)
print(df1700.head())
df1700.to_csv('path to .csv')
